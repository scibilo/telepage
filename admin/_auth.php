 ...
 * Guard di autenticazione condiviso per tutte le pagine admin.
 * Include in cima a ogni pagina admin (dopo define TELEPAGE_ROOT).
 */
...
// CSRF token globale per le pagine admin
...
HTML;
    ...
    $labels = ['dashboard' => 'Dashboard', 'contents' => 'Contenuti', 'tags' => 'Tag', 'import' => 'Import', 'scanner' => 'History Scanner', 'settings' => 'Impostazioni'];
    ...
    echo <<<HTML
        <div class="nav-section">Sito</div>
        <a href="../index.php" class="nav-link" target="_blank"><span class="nav-icon">🌐</span>Vedi sito</a>
    </nav>
