 ...
 * Asynchronous content loading via AJAX (api/contents.php).
 */
...
// Check if admin is logged in (for trash and admin link)
...
// Show only tags that have active associated contents
// Generate deterministic vivid colour from tag name (used if color is the default grey)
    ...
    <div class="app-layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <section>
                ...
                <?php if (count($tags) > 8): ?>
                <input type="text" id="tag-search" class="search-input" placeholder="Search tags..."
